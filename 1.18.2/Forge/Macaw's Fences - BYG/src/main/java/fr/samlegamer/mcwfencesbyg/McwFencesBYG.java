...
public class McwFencesBYG
{
	...
	{
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.modern_soapstone_wall.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.railing_soapstone_wall.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.soapstone_railing_gate.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.soapstone_pillar_wall.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.soapstone_grass_topped_wall.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.modern_travertine_wall.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.railing_travertine_wall.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.travertine_railing_gate.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.travertine_pillar_wall.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.travertine_grass_topped_wall.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.modern_dacite_wall.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.railing_dacite_wall.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.dacite_railing_gate.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.dacite_pillar_wall.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.dacite_grass_topped_wall.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.modern_red_rock_wall.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.railing_red_rock_wall.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.red_rock_railing_gate.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.red_rock_pillar_wall.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.red_rock_grass_topped_wall.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.modern_scoria_stone_wall.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.railing_scoria_stone_wall.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.scoria_stone_railing_gate.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.scoria_stone_pillar_wall.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.scoria_stone_grass_topped_wall.get(), RenderType.cutout());
    	...
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.mangrove_picket_fence.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.mangrove_stockade_fence.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.mangrove_horse_fence.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.mangrove_wired_fence.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.mangrove_highley_gate.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.mangrove_pyramid_gate.get(), RenderType.cutout());
    	...
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.aspen_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.baobab_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.blue_enchanted_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.cika_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.cypress_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.ebony_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.ether_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.fir_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.green_enchanted_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.holly_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.jacaranda_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.lament_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.mahogany_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.maple_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.palm_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.pine_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.rainbow_eucalyptus_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.redwood_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.skyris_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.mangrove_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.willow_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.witch_hazel_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.zelkova_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.blue_spruce_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.orange_spruce_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.red_spruce_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.yellow_spruce_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.brown_birch_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.orange_birch_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.red_birch_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.yellow_birch_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.brown_oak_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.orange_oak_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.red_oak_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.white_cherry_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.pink_cherry_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.araucaria_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.blooming_witch_hazel_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.flowering_indigo_jacaranda_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.flowering_jacaranda_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.flowering_orchard_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.flowering_palo_verde_hedge.get(), RenderType.cutout());
    	ItemBlockRenderTypes.setRenderLayer(MFBYGBlocksRegistry.palo_verde_hedge.get(), RenderType.cutout());
	}
