...
public class MFBYGBlocksRegistry
{
	...
	private static final AbstractBlock.Properties WOOD = AbstractBlock.Properties.copy(Blocks.OAK_PLANKS).harvestTool(ToolType.AXE);
	private static final AbstractBlock.Properties HEDGES = AbstractBlock.Properties.copy(Blocks.OAK_LEAVES).harvestTool(ToolType.HOE);
	private static final AbstractBlock.Properties STONE = AbstractBlock.Properties.copy(Blocks.CUT_SANDSTONE).harvestTool(ToolType.PICKAXE);
