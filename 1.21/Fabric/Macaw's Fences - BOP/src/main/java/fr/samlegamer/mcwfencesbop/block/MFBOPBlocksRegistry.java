...
public class MFBOPBlocksRegistry
{
    ...
    {
    	Registry.register(Registries.BLOCK, Identifier.of(McwFencesBOP.MODID, name), b);
    	blockItem(b, name);
	}
    
    private static void blockItem(Block b, String n)
    {
        Registry.register(Registries.ITEM, Identifier.of(McwFencesBOP.MODID, n), new BlockItem(b, new Item.Settings()));
    }
}